...
`POST https://api.omnifront.cloudsnob.com/quotes/[shippingQuotesToken]/approve-shipping `
...
`POST https://api.omnifront.cloudsnob.com/quotes/{quoteToken}/cancel`
...
### HTTP Request
`DELETE https://api.omnifront.cloudsnob.com/quotes/all`
